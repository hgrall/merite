...
import {FormatMot, Mot, creerMot, binaire} from "../../bibliotheque/binaire";
import {
...
const domaines: Mot[] = [binaire(0), binaire(1), binaire(2), binaire(3)];
...
//methode noeud retourne la valeur de ID_dom
...
serveurCanaux.enregistrerTraitementMessages((l: LienJeu1, m: FormatMessageJeu1) => {
    ...
    switch (m.type) {
        case TypeMessageJeu1.INIT:
            // TODO tester erreurs
            console.log("Message INIT: creation message et envoie");           
        ...
        case TypeMessageJeu1.VERROU:
            // TODO tester erreurs.
            console.log("Message VERROU: message verrouille");
        ...
        case TypeMessageJeu1.ACTIF:
            // TODO tester erreurs.
            console.log("Message ACTIF: transmission du message");
...
serveurCanaux.enregistrerTraitementFermeture((l: LienJeu1, r: number, desc: string) => {
   /* console.log('TODO traitement fermeture');
    ...
    //let id = l.configuration().val().centre.ID;
    if ((connexions.contient(id_util) === undefined) || (!utilisateursConnectesParDomaine
        .contientUtilisateur(ID_dom, id_util))) {
